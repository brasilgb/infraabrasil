...
CREATE DATABASE IF NOT EXISTS abrasilsistema CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
GRANT ALL PRIVILEGES ON abrasilsistema.* TO 'abrasilsistema_user'@'%';
FLUSH PRIVILEGES;
SQL
